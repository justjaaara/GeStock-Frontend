...
type ClientRow = {
  code: string; name: string; ruc: string;
  city: string; country: string;
  phone: string; email: string;
  type: string; orders: number;
  lastSale: string; total: number;
  credit: number|null; status: string;
};
...
export class Client implements OnInit, OnDestroy {
  ...
  clients: ClientRow[] = [
    { code:'CL001', name:'Corporación ABC S.A.', ruc:'20123456789', city:'Lima', country:'Perú',
      phone:'(01) 234-5678', email:'compras@corpabc.com', type:'Mayorista', orders:28,
      lastSale:'2025-09-01', total:18450, credit:5000, status:'Activo' },

    { code:'CL002', name:'Oficinas del Sur', ruc:'20987654321', city:'Arequipa', country:'Perú',
      phone:'(054) 987-6543', email:'pedidos@oficsur.pe', type:'Distribuidor', orders:15,
      lastSale:'2025-08-30', total:12680, credit:3500, status:'Activo' },

    { code:'CL003', name:'TechStore Lima', ruc:'20456789123', city:'Lima', country:'Perú',
      phone:'(01) 456-7890', email:'ventas@techstore.com', type:'Minorista', orders:42,
      lastSale:'2025-09-02', total:8920, credit:1500, status:'Activo' },

    { code:'CL004', name:'Empresa Norte', ruc:'20789123456', city:'Trujillo', country:'Perú',
      phone:'(044) 789-1234', email:'admin@empresanorte.pe', type:'Mayorista', orders:8,
      lastSale:'2025-08-25', total:15200, credit:4000, status:'Inactivo' },

    { code:'CL005', name:'Departamento RR.HH.', ruc:'—', city:'Oficina Central', country:'—',
      phone:'Ext. 2401', email:'rrhh@empresa.com', type:'Interno', orders:65,
      lastSale:'2025-09-03', total:2180, credit:null, status:'Activo' },

    { code:'CL006', name:'Distribuidora Costa', ruc:'20321665487', city:'Lima', country:'Perú',
      phone:'(01) 321-6549', email:'ventas@distcosta.pe', type:'Distribuidor', orders:22,
      lastSale:'2025-08-28', total:9840, credit:2500, status:'Moroso' },
  ];
